...
#define IIR_A_COEFFICIENT_COUNT 2001
#define IIR_B_COEFFICIENT_COUNT 2001
#define X_QUEUE_SIZE 2001
#define Y_QUEUE_SIZE 2001
...
void initXQueue(){
  for(uint8_t i = 0; i < X_QUEUE_SIZE; i++){
